...
import numpy as np
from harl.models.base.hierarchy import Hierarchy
from harl.models.base.act import ACTLayer


class HiePolicy(nn.Module):
    ...
    def forward(
        ...
        x = self.hie_model(obs, edges, self.n_nodes)
