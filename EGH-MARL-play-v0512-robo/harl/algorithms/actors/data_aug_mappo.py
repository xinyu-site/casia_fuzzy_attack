...
class MAPPO_data_aug(OnPolicyBase):
    def __init__(self, args, obs_space, act_space, device=torch.device("cpu")):
        ...
        """
        super(MAPPO_data_aug, self).__init__(args, obs_space, act_space, device)
    ...
    def share_param_train(self, actor_buffer, actor_buffer_90, actor_buffer_180, actor_buffer_270, advantages, num_agents, state_type):
        ...
        for _ in range(self.ppo_epoch):
            ...
            for agent_id in range(num_agents):
                if self.use_recurrent_policy:
                    ...
                    data_generator0 = actor_buffer[agent_id].feed_forward_generator_actor(
                        advantages_list[agent_id], self.actor_num_mini_batch
                    )
                    data_generators.append(data_generator0)

                    # data_generator1 = actor_buffer_90[agent_id].feed_forward_generator_actor(
                    #     advantages_list[agent_id], self.actor_num_mini_batch
                    # )
                    # data_generators.append(data_generator1)

                    # data_generator2 = actor_buffer_180[agent_id].feed_forward_generator_actor(
                    #     advantages_list[agent_id], self.actor_num_mini_batch
                    # )
                    # data_generators.append(data_generator2)

                    data_generator = actor_buffer_270[agent_id].feed_forward_generator_actor(
                        advantages_list[agent_id], self.actor_num_mini_batch
                    )
