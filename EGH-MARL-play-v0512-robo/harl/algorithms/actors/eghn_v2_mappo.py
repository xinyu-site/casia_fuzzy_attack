...
from harl.models.policy_models.eghn_v2_policy import Eghnv2Policy


class EGHNv2MAPPO(OnPolicyBase):
    def __init__(self, args, obs_space, act_space, device=torch.device("cpu")):
        ...
        """
        super(EGHNv2MAPPO, self).__init__(args, obs_space, act_space, device)
        ...
        self.actor = Eghnv2Policy(args, self.obs_space, self.act_space, self.device)
    ...
    def update(self, sample):
        ...
        return policy_loss, dist_entropy, actor_grad_norm, imp_weights, lp_loss
    ...
    def train(self, actor_buffer, advantages, state_type):
        ...
        for _ in range(self.ppo_epoch):
            ...
            for sample in data_generator:
                policy_loss, dist_entropy, actor_grad_norm, imp_weights, lp_loss = self.update(sample)
        ...
        for _ in range(self.ppo_epoch):
            ...
            for _ in range(self.actor_num_mini_batch):
                ...
                for j in range(8):
                    ...
                    del temp_obs
                policy_loss, dist_entropy, actor_grad_norm, imp_weights, lp_loss = self.update(
                    tuple(adjust_batches)
                )
