...
from harl.models.policy_models.hama_policy import HamaPolicy

class HamaMAPPO(OnPolicyBase):
    def __init__(self, args, obs_space, act_space, device=torch.device("cpu")):
        ...
        """
        super(HamaMAPPO, self).__init__(args, obs_space, act_space, device)
        ...
        self.actor = HamaPolicy(args, self.obs_space, self.act_space, self.device)
