...
from harl.models.policy_models.eghn_policy import EghnPolicy


class EGHNMAPPO(OnPolicyBase):
    def __init__(self, args, obs_space, act_space, device=torch.device("cpu")):
        ...
        """
        super(EGHNMAPPO, self).__init__(args, obs_space, act_space, device)
        ...
        self.actor = EghnPolicy(args, self.obs_space, self.act_space, self.device)
