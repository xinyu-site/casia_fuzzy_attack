...
class TwinContinuousQCritic:
    ...
    def train(
        ...
        train_info["critic2_grad_norm"] = 0
        ...
        train_info["critic_grad_norm"] += get_grad_norm(self.critic.parameters())
        train_info["critic2_grad_norm"] += get_grad_norm(self.critic2.parameters())
        return train_info
