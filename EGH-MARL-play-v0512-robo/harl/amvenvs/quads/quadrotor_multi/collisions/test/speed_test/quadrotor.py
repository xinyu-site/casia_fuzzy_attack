...
from amb.envs.quads.quadrotor_multi.collisions.quadrotors import compute_col_norm_and_new_velocities
from amb.envs.quads.quadrotor_multi.collisions.utils import compute_new_vel, compute_new_omega
...
def test_perform_collision_between_drones():
    ...
    SETUP_CODE = '''from amb.envs.quads.quadrotor_multi.collisions.quadrotors import perform_collision_between_drones; import numpy as np'''
