...
from amb.envs.quads.quadrotor_multi.aerodynamics.downwash import perform_downwash
from amb.envs.quads.quadrotor_multi.collisions.obstacles import perform_collision_with_obstacle
from amb.envs.quads.quadrotor_multi.collisions.quadrotors import calculate_collision_matrix, \
    calculate_drone_proximity_penalties, perform_collision_between_drones
from amb.envs.quads.quadrotor_multi.collisions.room import perform_collision_with_wall, perform_collision_with_ceiling
from amb.envs.quads.quadrotor_multi.obstacles.utils import get_cell_centers
from amb.envs.quads.quadrotor_multi.quad_utils import QUADS_OBS_REPR, QUADS_NEIGHBOR_OBS_TYPE

from amb.envs.quads.quadrotor_multi.obstacles.obstacles import MultiObstacles
from amb.envs.quads.quadrotor_multi.quadrotor_multi_visualization import Quadrotor3DSceneMulti
from amb.envs.quads.quadrotor_multi.quadrotor_single import QuadrotorSingle
from amb.envs.quads.quadrotor_multi.scenarios.mix import create_scenario
...
class QuadrotorEnvMulti(gym.Env):
    ...
    def obst_generation_given_density(self, grid_size=1.0):
        ...
        self.obst_density = np.clip(self.obst_density,0,1)
