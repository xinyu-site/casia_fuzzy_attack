...
if __name__ == "__main__":
    from amb.envs.quads.quadrotor_multi.obstacles.test.unit_test import unit_test
    from amb.envs.quads.quadrotor_multi.obstacles.test.speed_test import speed_test
