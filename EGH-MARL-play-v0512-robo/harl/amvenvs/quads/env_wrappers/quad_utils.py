...
from amb.envs.quads.quadrotor_multi.quad_experience_replay import ExperienceReplayWrapper
from amb.envs.quads.env_wrappers.compatibility import QuadEnvCompatibility
from amb.envs.quads.env_wrappers.reward_shaping import DEFAULT_QUAD_REWARD_SHAPING, QuadsRewardShapingWrapper
from amb.envs.quads.env_wrappers.v_value_map import V_ValueMapWrapper
...
def make_quadrotor_env_multi(cfg, render_mode=None, **kwargs):
    from amb.envs.quads.quadrotor_multi.quadrotor_multi import QuadrotorEnvMulti
    quad = 'Crazyflie'
