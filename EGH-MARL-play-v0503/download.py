...
log_file_path = '/home/yuxin/fuzzymarl/casia_fuzzy_attack/EGH-MARL-play-v0503/results_eswa/pursuit/hepnlocal-direct-tac/mappo_data_aug/test/seed-00020-2026-05-03-18-10-04'
...
# log_file_path = '/home/yuxin/fuzzymarl/casia_fuzzy_attack/EGH-MARL-play-v0503/results_eswa/pursuit/hepnlocal-direct-tac/egnnv2_mappo/test/seed-00020-2026-05-03-18-06-36'
# match = re.search(r'results_eswa/([^/]+)/([^/]+)/([^/]+)/([^/]+)', log_file_path)
# task, setting, algorithm, name = match.groups()
# if task in ['smacv2']:
#     log_file_path += '/logs/eval_win_rate/eval_win_rate/'
