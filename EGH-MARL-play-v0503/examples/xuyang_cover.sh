...
python train.py --algo mappo --env cover --exp_name test --obs_mode global --local_mode False --nr_agents 10 --obs_radius 141.5 --seed 20 --num_env_steps 10000000 --use_recurrent_policy False --torus False
