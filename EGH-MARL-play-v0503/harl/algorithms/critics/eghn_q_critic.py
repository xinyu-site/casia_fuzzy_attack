...
from harl.models.value_function_models.eghn_q_net import EghnQNet
from harl.utils.envs_tools import check
from harl.utils.models_tools import get_grad_norm

class EghnQCritic(ContinuousQCritic):
    def __init__(self, args, share_obs_space, act_space, num_agents, state_type, device=torch.device("cpu")):
        ...
        self.critic = EghnQNet(args, share_obs_space, act_space, device)
