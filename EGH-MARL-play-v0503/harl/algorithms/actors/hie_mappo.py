...
from harl.models.policy_models.hie_policy import HiePolicy

class HieMAPPO(OnPolicyBase):
    def __init__(self, args, obs_space, act_space, device=torch.device("cpu")):
        ...
        """
        super(HieMAPPO, self).__init__(args, obs_space, act_space, device)
        ...
        self.actor = HiePolicy(args, self.obs_space, self.act_space, self.device)
