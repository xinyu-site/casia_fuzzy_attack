...
from harl.models.policy_models.GraphSAGE_policy import GraphSAGEPolicy
# from harl.models.policy_models.stochastic_policy import StochasticPolicy

class GrapgSAGEMAPPO(OnPolicyBase):
    def __init__(self, args, obs_space, act_space, device=torch.device("cpu")):
        ...
        """
        super(GrapgSAGEMAPPO, self).__init__(args, obs_space, act_space, device)
        ...
        self.actor = GraphSAGEPolicy(args, self.obs_space, self.act_space, self.device)
