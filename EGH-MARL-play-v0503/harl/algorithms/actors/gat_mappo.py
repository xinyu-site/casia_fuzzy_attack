...
from harl.models.policy_models.gat_policy import GATPolicy
from harl.models.policy_models.stochastic_policy import StochasticPolicy

class GATMAPPO(OnPolicyBase):
    def __init__(self, args, obs_space, act_space, device=torch.device("cpu")):
        ...
        """
        super(GATMAPPO, self).__init__(args, obs_space, act_space, device)
        ...
        self.actor = GATPolicy(args, self.obs_space, self.act_space, self.device)
