...
from harl.models.policy_models.egnn_v2_policy import EgnnV2Policy


class EGNNv2MAPPO(OnPolicyBase):
    def __init__(self, args, obs_space, act_space, device=torch.device("cpu")):
        ...
        """
        super(EGNNv2MAPPO, self).__init__(args, obs_space, act_space, device)
        ...
        self.actor = EgnnV2Policy(args, self.obs_space, self.act_space, self.device)
