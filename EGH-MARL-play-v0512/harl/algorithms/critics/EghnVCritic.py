...
from harl.models.value_function_models.eghn_critic_net import EghnCriticNet
from harl.algorithms.critics.v_critic import VCritic


class EghnVCritic(VCritic):
    """V Critic.
    Critic that learns a V-function.
    """
    def __init__(self, args, cent_obs_space, device=torch.device("cpu")):
        super(EghnVCritic, self).__init__(args, cent_obs_space, device)
