...
class HepnCriticNet(nn.Module):
    ...
    def __init__(self, args, cent_obs_space, device=torch.device("cpu")):
        ...
        """
        super(HepnCriticNet, self).__init__()
        self.args = args
        ...
        self.local_tool = local_tool(self, args=args, net_type="hepn", id="critic")
        ...
        self.critic_fc1 = nn.Linear(1 + self.hidden_sizes[-1], 1)
        # self.critic_fc1 = nn.Linear(self.n_vector_input * self.n_vector_input + self.hidden_sizes[-1], 1)
        self.to(device)
    ...
    def forward(self, cent_obs, rnn_states, masks, layer_data):
        ...
        # cent_obs, g_list = self.local_tool.trans_info2graph_critic(cent_obs)
        ...
        loc_pred, vel_pred, h = self.eghn_model(
        ...
        # x = torch.matmul(mu.transpose(1, 2), mu)
