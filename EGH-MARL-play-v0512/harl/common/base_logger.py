...
class BaseLogger:
    ...
    def __init__(self, args, algo_args, env_args, num_agents, writter, run_dir):
        ...
        self.train_log_file = open(
            os.path.join(run_dir, "train_progress.txt"), "w", encoding="utf-8"
        )
    ...
    def eval_thread_done(self, tid):
        ...
        #print(np.sum(self.one_episode_rewards[tid], axis=0))
    ...
    def log_train_offpolicy(self, actor_train_infos, critic_train_info, total_it):
        # log actor
        self.total_num_steps = (
            total_it
