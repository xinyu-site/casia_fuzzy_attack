...
class EghnCriticNet(nn.Module):
    ...
    def __init__(self, args, cent_obs_space, device=torch.device("cpu")):
        ...
        """
        super(EghnCriticNet, self).__init__()
        self.args = args
        ...
        # if args["obs_mode"] == 'local_obs_mode':
        #     in_node_nf = self.inv_nf - self.n_nodes
        # else:
        #     in_node_nf = self.inv_nf
    ...
    def forward(self, cent_obs, rnn_states, masks):
        ...
        # equ_fea = cent_obs[:, -self.equ_nf:]
        # inv_fea = cent_obs[:, :-self.equ_nf]
        ...
        loc_pred, vel_pred, h = self.eghn_model(loc, h, edges, edge_attr, local_edge_index, 
                                                edge_attr, n_node=self.n_nodes, v=vel, node_mask=None, 
                                                node_nums=None, flag=True)
