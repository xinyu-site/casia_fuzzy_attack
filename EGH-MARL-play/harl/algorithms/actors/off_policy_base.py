...
class OffPolicyBase:
    ...
    def lr_decay(self, step, steps, decay_mode="linear"):
        ...
        if decay_mode == "linear":
            ...
            update_exponential_decay(self.actor_optimizer, step, steps, self.lr)
        elif decay_mode == "polynomial":
            update_polynomial_decay(self.actor_optimizer, step, steps, self.lr)
        elif decay_mode == "customized":
            update_customized_decay(self.actor_optimizer, step, steps, self.lr)
        elif decay_mode == "cosine":
            update_cosine_decay(self.actor_optimizer, step, steps, self.lr)
        elif decay_mode == "step":
            update_step_decay(self.actor_optimizer, step, steps, self.lr)
        else:
