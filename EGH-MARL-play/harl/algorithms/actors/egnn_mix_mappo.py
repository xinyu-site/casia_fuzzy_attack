...
from harl.models.policy_models.egnn_mix_policy import EgnnMixPolicy


class EGNNMIXMAPPO(OnPolicyBase):
    def __init__(self, args, obs_space, act_space, device=torch.device("cpu")):
        ...
        """
        super(EGNNMIXMAPPO, self).__init__(args, obs_space, act_space, device)
        ...
        self.actor = EgnnMixPolicy(args, self.obs_space, self.act_space, self.device)
