...
from harl.models.policy_models.hmf_policy import HmfPolicy

class HmfMAPPO(OnPolicyBase):
    def __init__(self, args, obs_space, act_space, device=torch.device("cpu")):
        ...
        """
        super(HmfMAPPO, self).__init__(args, obs_space, act_space, device)
        ...
        self.actor = HmfPolicy(args, self.obs_space, self.act_space, self.device)
