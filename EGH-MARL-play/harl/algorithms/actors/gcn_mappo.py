...
from harl.models.policy_models.gcn_policy import GCNPolicy
# from harl.models.policy_models.stochastic_policy import StochasticPolicy

class GCNMAPPO(OnPolicyBase):
    def __init__(self, args, obs_space, act_space, device=torch.device("cpu")):
        ...
        """
        super(GCNMAPPO, self).__init__(args, obs_space, act_space, device)
        ...
        self.actor = GCNPolicy(args, self.obs_space, self.act_space, self.device)
