...
from harl.models.policy_models.egnn_v3_policy import EgnnV3Policy


class EGNNv3MAPPO(OnPolicyBase):
    def __init__(self, args, obs_space, act_space, device=torch.device("cpu")):
        ...
        """
        super(EGNNv3MAPPO, self).__init__(args, obs_space, act_space, device)
        ...
        self.actor = EgnnV3Policy(args, self.obs_space, self.act_space, self.device)
