...
from harl.models.policy_models.egnn_policy import EgnnPolicy


class EGNNMAPPO(OnPolicyBase):
    def __init__(self, args, obs_space, act_space, device=torch.device("cpu")):
        ...
        """
        super(EGNNMAPPO, self).__init__(args, obs_space, act_space, device)
        ...
        self.actor = EgnnPolicy(args, self.obs_space, self.act_space, self.device)
